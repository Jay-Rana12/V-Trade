...
const refinedOverrides = `
/* ===== MASTER UI OVERRIDES FOR PREMIUM LOOK (UPDATED) ===== */

/* Search Bar - Pure White & Elegant */
.search-bubble {
    background: #ffffff !important;
    border: 1px solid rgba(255, 255, 255, 0.3) !important; /* Lighter border */
...
/* Make icons in search bar less stark */
...
/* Fix for locations badge text if it looks dark */
...
content += refinedOverrides;

fs.writeFileSync(cssPath, content, 'utf8');
console.log('Refined Master UI Overrides (Whiter Search Bar) applied.');
