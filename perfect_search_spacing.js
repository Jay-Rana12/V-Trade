...
const perfectBubbleHTML = `<div class="search-bubble top-search intel-search-container">
...
for (const file of files) {
    ...
    if (fullBubbleRegex.test(content)) {
        content = content.replace(fullBubbleRegex, perfectBubbleHTML);
        fs.writeFileSync(filePath, content, 'utf8');
        console.log(`Perfected spacing and layout for search bar in ${file}`);
    }
}
