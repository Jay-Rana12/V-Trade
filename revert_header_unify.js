...
/* ===== MASTER UI OVERRIDES FOR PREMIUM LOOK ===== */

/* Search Bar - Force White Theme */
.search-bubble {
...
// Remove the new "UNIFIED PREMIUM HEADER" block
const unifiedMarker = '/* ===== UNIFIED PREMIUM HEADER';
if (content.includes(unifiedMarker)) {
    content = content.split(unifiedMarker)[0];
}

// Restore MASTER UI OVERRIDES
content += masterOverrides;

fs.writeFileSync(cssPath, content, 'utf8');
console.log('Successfully reverted to Master UI Overrides.');
