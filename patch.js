...
const targetFile = "c:\\Users\\AE\\OneDrive\\Desktop\\redesign\\services.html";
...
if(startIdx1 !== -1 && endIdx1 !== -1) {
    let endStr = content.substring(endIdx1, content.indexOf('}', endIdx1) + 1);
    content = content.substring(0, startIdx1) + css_replacement + "\\n" + content.substring(content.indexOf('}', endIdx1) + 1);
} else { console.log('CSS block not found'); }
...
} else { console.log('HTML block not found'); }
...
} else { console.log('JS block not found'); }
