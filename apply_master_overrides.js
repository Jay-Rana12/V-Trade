...
// Remove previous overrides block if it exists and append new one
const marker = '/* ===== MASTER UI OVERRIDES';
if (cssContent.includes(marker)) {
    cssContent = cssContent.split(marker)[0];
}
cssContent += masterOverrides;

fs.writeFileSync(cssPath, cssContent, 'utf8');
console.log('Master UI Overrides applied to style.css');
